package ca.gainzassist.activities.authentication
...
import ca.gainzassist.activities.authentication.login.LoginScreen
import ca.gainzassist.activities.authentication.login.LoginUiState
import ca.gainzassist.activities.main.Main
import ca.gainzassist.activities.main.Main.Companion.EXTRA_LOGOUT_USER
import ca.gainzassist.util.Preferences.setUserInfoPref
import ca.gainzassist.util.UI.setInitTheme
import ca.gainzassist.util.firebase.Authentication.RC_SIGN_IN
import ca.gainzassist.util.firebase.Authentication.createUser
import ca.gainzassist.util.firebase.Authentication.linkUser
import ca.gainzassist.util.firebase.Authentication.signIn
import ca.gainzassist.util.firebase.Authentication.signOut
import ca.gainzassist.util.firebase.Database.setUserInfo
