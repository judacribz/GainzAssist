...
class ExerciseEntryFragment : Fragment() {
    ...
    interface ExEntryDataListener {
        fun exerciseDoesNotExist(fmt: ExerciseEntryFragment, exerciseName: String?, skipIndex: Int): Boolean
                    ...
                    actions = object : ExEntryActions {
                        ...
                        override fun onWeightChanged(weight: String) {
                            ...
                            if (parsedWeight != null) {
                                this@ExerciseEntryFragment.weight = parsedWeight
                                uiState =
                                    uiState.copy(canDecrementWeight = this@ExerciseEntryFragment.weight > minWeight)
                            }
                        }
