...
fun ExercisesEntryScreen(
    ...
    LaunchedEffect(pagerState.currentPage, pagerState.isScrollInProgress) {
        if (!pagerState.isScrollInProgress && pagerState.currentPage != uiState.selectedIndex) {
...
@Composable
fun ExercisesEntryScreenPreviewOneExercise() {
    MaterialTheme {
...
@Preview(showBackground = true)
@Composable
fun ExercisesEntryScreenPreviewMultipleExercises() {
    MaterialTheme {
        ExercisesEntryScreen(
            uiState = ExercisesEntryUiState(
                selectedIndex = 1,
...
@Preview(showBackground = true)
@Composable
fun ExercisesEntryScreenPreviewWithPlusTab() {
    MaterialTheme {
        ExercisesEntryScreen(
            uiState = ExercisesEntryUiState(
                selectedIndex = 0,
...
@Preview(showBackground = true)
@Composable
fun ExercisesEntryScreenPreviewSelectedLastExercise() {
    MaterialTheme {
        ExercisesEntryScreen(
            uiState = ExercisesEntryUiState(
                selectedIndex = 2,
...
@PreviewScreenSizes
@Composable
fun ExercisesEntryScreenPreviewSmallPhone() {
    MaterialTheme {
        ExercisesEntryScreen(
            uiState = ExercisesEntryUiState(
                selectedIndex = 0,
...
@PreviewFontScale
@Composable
fun ExercisesEntryScreenPreviewLargeFont() {
    MaterialTheme {
        ExercisesEntryScreen(
            uiState = ExercisesEntryUiState(
                selectedIndex = 0,
