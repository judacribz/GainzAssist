...
@Composable
private fun HowToVideosScreenPreviewEmpty() {
    HowToVideosScreen(
...
@Preview(showBackground = true, backgroundColor = 0xFF000000)
@Composable
private fun HowToVideosScreenPreviewWithResults() {
    HowToVideosScreen(
        uiState = HowToVideosUiState(
            videos = listOf(
...
@Preview(showBackground = true, backgroundColor = 0xFF000000)
@Composable
private fun HowToVideosScreenPreviewPlayerVisible() {
    HowToVideosScreen(
        uiState = HowToVideosUiState(
...
@Preview(showBackground = true, backgroundColor = 0xFF000000)
@Composable
private fun HowToVideosScreenPreviewLongTitles() {
    HowToVideosScreen(
        uiState = HowToVideosUiState(
            videos = listOf(
                HowToVideoUiItem(
...
@Composable
private fun HowToVideosScreenPreviewSmallPhone() {
    HowToVideosScreen(
        uiState = HowToVideosUiState(
            isPlayerVisible = true,
            videos = listOf(
...
@Composable
private fun HowToVideosScreenPreviewLargeFont() {
    HowToVideosScreen(
        uiState = HowToVideosUiState(
            videos = listOf(
                HowToVideoUiItem("1", HOW_TO_SQUAT)
