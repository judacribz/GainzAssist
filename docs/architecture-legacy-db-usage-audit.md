...
- **Completed**: `FirebaseService` was successfully migrated off `WorkoutRepo` to use `WorkoutRepository` and coroutines.
...
**Status**: NOT safe to remove yet. `WorkoutViewModel` depends on it.
